...
if (dFlag)
    ...
    dmexpdt = 1i*w.*lp.kx.*exp(1i*lp.kx.*lp.t);
    dPdt = StampRow3(dPdt, dexpdt, Z, Z, dmexpdt);% Why use dmexpdt instead of conj(dexpdt))? Because for complex kx (lossy materials), conj doesn't work.
