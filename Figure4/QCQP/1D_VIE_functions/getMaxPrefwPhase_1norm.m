function [maxP,phiMat,Eref,phase,solnMat] = ...
    getMaxPrefwPhase_1norm(n,L,M,inputPhase,threshold,e)
    ...
    cvx_begin sdp quiet
        ...
        subject to
            ...
            X >= 0;
            trace(GP2Opt*X) == 0;
            1-abs(1-trace(GP1Opt*X)) >= sqrt(threshold);
      cvx_end

    maxP = (1-abs(1-trace(GP1Opt*X)))^2;
